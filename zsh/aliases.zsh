...
if [[ -o interactive ]]; then
  ...
  alias photobooth='cd /Users/jeff/Pictures/Photo Booth Library/Pictures'
  alias books='cd ~/Books'
  alias cdl='cd ~/Downloads'
  alias ctil='cd ~/Notes/til'
  alias cdoc='cd ~/Documents'
  alias onenote='cd ~/Library/Containers/com.microsoft.onenote.mac/Data/Library/Application Support/Microsoft User Data/OneNote'
  alias snip='cd /Users/jeff/.config/nvim/plugged/vim-snippets'
  ...
  alias s8m='cd /Volumes/seag8silver/Media'
  alias s8p='cd /Volumes/seag8silver/Media/dev-learning/pluralsight'
  ...
  alias ibooks='cd /Users/jeff/Library/Containers/com.apple.BKAgentService/Data/Documents/iBooks/Books'
  ...
  alias irc='weechat'
  alias nodew='env NODE_NO_READLINE=1 rlwrap node'
  alias noder='rlwrap -z node_complete rlwrap_node.js'
