...
| ChatGPT / Gemini | ctrl+backslash | Toggle the sidebar (local Chrome content script) | — |
| ChatGPT / Gemini | ctrl+k | Search chats, not page text (`ctrl+f` remains page search) | — |
