...
# briss: Crop PDF files # choose-rust: Human-friendly and fast alternative to cut and (sometimes) awk
...
# sad: Search and replace | Space Age seD
...
# gocmdpev: Command-line GO Postgres query visualizer
...
# parity: Shell commands for environment parity for Heroku apps
...
# unused: Identify potentially unused code
