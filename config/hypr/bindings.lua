...
o.bind("SUPER + H", "Pick window", "omarchy-launch-floating-terminal-with-presentation hypr-window-switcher")
o.bind("SUPER + L", "Pick window", "omarchy-launch-floating-terminal-with-presentation hypr-window-switcher")
