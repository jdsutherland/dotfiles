# Generated by Powerlevel10k configuration wizard on 2021-08-05 at 12:26 MST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # mise activates runtimes, but has no native Powerlevel10k segment.
  ...
  # mise activates runtimes in zshrc; Powerlevel10k has no native mise segment.
